...
.. tabs::
  .. group-tab:: MRW.v1.0
    ...
    * Positive bias of sea level pressure in Midwestern U.S. and Southern Ontario existed in both MRW_GFSv15p2 and MRW_GFSv16beta simulations, featuring with clearer skies.
    * The surface flow pattern over Midwestern U.S was from northwest in the model, which lead more cold air from Canada compared with GFS_ANL.
    ...
    * Both two physics compsets simulated a positive trough over Ontario, which usually generates the least amount of severe weather.
  ...
  .. group-tab:: GFS.v16.0.10
    ...
    * GFS.v16.0.10 simulated higher sea level pressure and weaker pressure gradient over Ontario, and lower sea level pressure over the Northeast.
    * The surface flow pattern over Midwestern U.S was from northwest in the model, which lead more cold air from Canada compared with GFS_ANL. 
    ...
    * A positive tilted trough was located at Ontario in GFS.v16.0.10, while not in GFS_ANL
...
.. tabs::
  .. group-tab:: MRW.v1.0
    ...
    * MRW_GFSv16beta and MRW_GFSv15p2 generated a cold bias over central U.S. and Ontario during this Arctic cold blast event.
    ...
    * The surface wind gust over Ontario was not simulated well in the model, which is related to the higher simulated surface pressure and weaker pressure gradient at this region.
  ...
  .. group-tab:: GFS.v16.0.10
    ...
    * Consistent cold bias (larger than -15 F) existed over Ontario and scattered cold bias over Midwest.
    ...
    * GFS.v16.0.10 simulated weaker wind speed across Midwest and Ontario.