...
.. tabs::
  ...
  .. group-tab:: SRW.v1.0
    ...
    The case runs are initialized at 12z Feb 03, 2020 with 90 hours forecasting.The app uses ``config.sh`` to define the runtime settings. The settings that need to be modified to set up the first cycle, last cycle, forecast length and cycle hour are listed below. 
    ...
    .. container:: sphx-glr-footer
      ...
      .. container:: sphx-glr-download sphx-glr-download-python
        ...
        :download:`Download initial condition files: 2020020312_srw.gfs.nemsio.tar.gz <https://ufs-case-studies.s3.amazonaws.com/2020020312_srw.gfs.nemsio.tar.gz>`
...
.. tabs::
  ...
  .. group-tab:: SRW.v1.0
    ...
    * SRW_RRFS_v1alpha more correctly forecasts the surface low than SRW_GFSv15p2.
    ...
    * Both SRW_GFSv16beta and SRW_GFSv15p2 simulate a positively tilted trough, same as RAP_ANL.
...
.. tabs::
  ...
  .. group-tab:: SRW.v1.0
    ...
    * Cold air was dammed up along the Appalachian mountains in RAP_ANL.
    * Both SRW_RRFS_v1alpha and SRW_GFSv15p2 generates warm bias along the east side of Appalachian.
    * Specifically, SRW_RRFS_v1alpha simulates warmer temperatures over Ohio.
    ...
    * Stronger surface winds are simulated by SRW_RRFS_v1alpha and SRW_GFSv15p2.
